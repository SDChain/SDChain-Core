...
#ifndef SDCHAIN_OVERLAY_PEERIMP_H_INCLUDED
#define SDCHAIN_OVERLAY_PEERIMP_H_INCLUDED

#include <sdchain/app/consensus/RCLCxPeerPos.h>
#include <sdchain/basics/Log.h>
#include <sdchain/beast/core/ByteOrder.h>
#include <sdchain/beast/utility/WrappedSink.h>
#include <sdchain/overlay/impl/ProtocolMessage.h>
...
public:
    ...
    */
    ...
    enum class State
    {
        ...
        /** Running the SDChain protocol actively */
        ,active
    };
...
public:
    ...
    */
    ...
    /** Return the version of sdchaind that the peer is running, if reported. */
    std::string
    getVersion() const;
