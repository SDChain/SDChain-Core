...
#include <sdchain/overlay/impl/ConnectAttempt.h>
#include <sdchain/overlay/impl/PeerImp.h>
#include <sdchain/peerfinder/make_Manager.h>
...
OverlayImpl::onPrepare()
{
    ...
    if (bootstrapIps.empty ())
        bootstrapIps.push_back ("r.sdchain.io 51235");
    ...
    // Add the ips_fixed from the sdchaind.cfg file
...
/** The number of active peers on the network
    ...
    and are running the SDChain protocol.
*/
std::size_t
OverlayImpl::size()
{
