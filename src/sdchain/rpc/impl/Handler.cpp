...
#include <sdchain/rpc/handlers/Version.h>
...
Handler handlerArray[] {
    ...
    {   "nosdchain_check",       byRef (&doNoSDChainCheck),       Role::USER,  NO_CONDITION  },
...
//      {   "profile",              byRef (&doProfile),             Role::USER,  NEEDS_CURRENT_LEDGER  },
    ...
    {   "sdchain_path_find",     byRef (&doSDChainPathFind),      Role::USER,  NO_CONDITION  },
