...
Json::Value doSDChainPathFind (RPC::Context& context)
{
        ...
        ! context.params.isMember(jss::ledger_hash))
    {
        ...
        //
        // 1. We're running doSDChainPathFind() due to a call to
        //    sdchain_path_find.  doSDChainPathFind() is currently running
        //    inside of a JobQueue::Coro using a JobQueue thread.
        //
        // 2. doSDChainPathFind's call to makeLegacyPathRequest() enqueues the
        ...
        // sdchaind source code) shutting down the application.  The code to
