...
#ifndef SDCHAIN_APP_TX_TRANSACTIONMETA_H_INCLUDED
#define SDCHAIN_APP_TX_TRANSACTIONMETA_H_INCLUDED
...
// VFALCO Move to sdchain/app/ledger/detail, rename to TxMeta
class TxMeta
{
public:
