...
#ifndef SDCHAIN_LEDGER_READVIEW_H_INCLUDED
#define SDCHAIN_LEDGER_READVIEW_H_INCLUDED

#include <sdchain/ledger/detail/ReadViewFwdRange.h>
...
#include <sdchain/ledger/detail/ReadViewFwdRange.ipp>
