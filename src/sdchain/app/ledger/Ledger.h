...
#ifndef SDCHAIN_APP_LEDGER_LEDGER_H_INCLUDED
#define SDCHAIN_APP_LEDGER_LEDGER_H_INCLUDED
...
public:
    ...
    /** Create the Genesis ledger.
        ...
        computed from the string "sdchainpassphrase" and ordinal
        zero.

        The account has an SDA balance equal to the total amount
        of SDA in the system. No more SDA than the amount which
    ...
    */
    ...
    void
    rawDestroySDA (SDAAmount const& fee) override
    {
        info_.drops -= fee;
		info_.feepool += fee;
    }
