...
#ifndef SDCHAIN_APP_BOOK_OFFER_H_INCLUDED
#define SDCHAIN_APP_BOOK_OFFER_H_INCLUDED
...
template<>
inline
void TOffer<IOUAmount, SDAAmount>::setFieldAmounts ()
{
    m_entry->setFieldAmount (sfTakerPays, toSTAmount(m_amounts.in, issIn_));
...
template<>
inline
void TOffer<SDAAmount, IOUAmount>::setFieldAmounts ()
{
