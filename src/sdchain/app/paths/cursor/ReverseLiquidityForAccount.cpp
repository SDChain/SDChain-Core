...
//
// Currency cannot be SDA because we are rippling.
//
...
TER PathCursor::reverseLiquidityForAccount () const
{
    ...
    // page section: https://sdchain.io/wiki/Transit_Fees#Implementation
    ...
    else if (!previousNodeIsAccount && nextNodeIsAccount)
    {
        ...
        else
        {
            ...
            // deliver -> redeem
            // TODO(tom): now we have more checking in nodeSDChain, these checks
            // might be redundant.
