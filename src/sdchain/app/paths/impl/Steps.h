...
#ifndef SDCHAIN_APP_PATHS_IMPL_PAYSTEPS_H_INCLUDED
#define SDCHAIN_APP_PATHS_IMPL_PAYSTEPS_H_INCLUDED
...
/**
   ...
   There are five concrete step classes:
     ...
     BookStepIX is an IOU/SDA offer book
     BookStepXI is an SDA/IOU offer book
     SDAEndpointStep is the source or destination account for SDA
...
public:
    ...
    */
    ...
    /**
       ...
       account. This is needed for checkNoSDChain.
    */
    ...
    // For SDA endpoints, one of src or dst will be the root account
...
struct StrandContext
{
    ...
    /** The previous step in the strand. Needed to check the no sdchain
        constraint
     */
