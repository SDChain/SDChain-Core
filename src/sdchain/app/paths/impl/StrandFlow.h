...
#ifndef SDCHAIN_APP_PATHS_IMPL_STRANDFLOW_H_INCLUDED
#define SDCHAIN_APP_PATHS_IMPL_STRANDFLOW_H_INCLUDED
...
/**
   ...
   @param strand Steps of Accounts to sdchain through and offer books to use
    ...
    beast::Journal j)
{
    ...
    if (isDirectSdaToSda<TInAmt, TOutAmt> (strand))
    {
        // The current implementation returns NO_LINE for SDA->SDA transfers.
        // Keep this behavior
...
/**
   ...
   @param baseView Trust lines and balances
   @param strands Each strand contains the steps of accounts to sdchain through
