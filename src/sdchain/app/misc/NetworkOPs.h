...
#ifndef SDCHAIN_APP_MISC_NETWORKOPS_H_INCLUDED
#define SDCHAIN_APP_MISC_NETWORKOPS_H_INCLUDED
...
/** Provides server functionality for clients.
    ...
    sdchaind / NetworkOPs. However, client software connecting to non-local
    instances of sdchaind will need to be hardened to protect against hostile
