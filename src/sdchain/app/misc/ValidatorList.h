...
#ifndef SDCHAIN_APP_MISC_VALIDATORLIST_H_INCLUDED
#define SDCHAIN_APP_MISC_VALIDATORLIST_H_INCLUDED
...
/**
    ...
    SDChaind accepts ledger proposals and validations from trusted validator
    ...
    This class manages the set of validation public keys the local sdchaind node
