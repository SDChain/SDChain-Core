...
#ifndef SDCHAIN_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED
#define SDCHAIN_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED
...
private:
    ...
    std::string const dbPrefix_ = "sdchaindb";
...
private:
    ...
    // If sdchaind is not healthy, defer rotate-delete.
