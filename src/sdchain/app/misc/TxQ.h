...
/*
    ...
    Copyright (c) 2012-14 SDChain Alliance.
...
#ifndef SDCHAIN_TXQ_H_INCLUDED
#define SDCHAIN_TXQ_H_INCLUDED
...
private:
    ...
    public:
        ...
        /**
            ...
            @param timeLeap Indicates that sdchaind is under load so fees
            should grow faster.
        */
        std::size_t
