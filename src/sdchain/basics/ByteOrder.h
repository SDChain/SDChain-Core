...
#ifndef SDCHAIN_BASICS_BYTEORDER_H_INCLUDED
#define SDCHAIN_BASICS_BYTEORDER_H_INCLUDED
...
// VFALCO These are all deprecated please use the ones in <sdchain/beast/core/ByteOrder.h>
