...
#ifndef SDCHAIN_PROTOCOL_STACCOUNT_H_INCLUDED
#define SDCHAIN_PROTOCOL_STACCOUNT_H_INCLUDED
...
private:
    ...
    // overhead in a sdchain::uint160.  However, so the serialized format of the
