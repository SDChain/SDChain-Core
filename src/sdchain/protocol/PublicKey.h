...
#ifndef SDCHAIN_PROTOCOL_PUBLICKEY_H_INCLUDED
#define SDCHAIN_PROTOCOL_PUBLICKEY_H_INCLUDED

#include <sdchain/basics/Slice.h>
#include <sdchain/crypto/KeyType.h> // move to protocol/
#include <sdchain/protocol/STExchange.h>
...
/** A public key.
    ...
    The format of the public key is SDChain specific,
