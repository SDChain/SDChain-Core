...
#ifndef SDCHAIN_PROTOCOL_JSONFIELDS_H_INCLUDED
#define SDCHAIN_PROTOCOL_JSONFIELDS_H_INCLUDED
...
JSS ( alternatives );               // out: PathRequest, SDChainPathFind
...
JSS ( base_fee_sda );               // out: NetworkOPs
...
JSS ( destination_account );        // in: PathRequest, SDChainPathFind, account_lines
                                    // out: AccountChannels
JSS ( destination_amount );         // in: PathRequest, SDChainPathFind
JSS ( destination_currencies );     // in: PathRequest, SDChainPathFind
...
JSS ( issuer );                     // in: SDChainPathFind, Subscribe,
...
JSS ( ledger_hash );                // in: RPCHelpers, LedgerRequest,
                                    //     SDChainPathFind, TransactionEntry,
                                    //     handlers/Ledger
...
JSS ( no_sdchain );                  // out: AccountLines
JSS ( no_sdchain_peer );             // out: AccountLines
...
JSS ( paths );                      // in: SDChainPathFind
JSS ( paths_canonical );            // out: SDChainPathFind
JSS ( paths_computed );             // out: PathRequest, SDChainPathFind
...
JSS ( reserve_base_sda );           // out: NetworkOPs
JSS ( reserve_inc );                // out: NetworkOPs
JSS ( reserve_inc_sda );            // out: NetworkOPs
JSS ( response );                   // websocket
JSS ( result );                     // RPC
JSS ( sdchain_lines );               // out: NetworkOPs
JSS ( sdchain_state );               // in: LedgerEntr
JSS ( sdchainrpc );                  // sdchain RPC version
JSS ( role );                       // out: Ping.cpp
JSS ( rt_accounts );                // in: Subscribe, Unsubscribe
JSS ( sanity );                     // out: PeerImp
JSS ( search_depth );               // in: SDChainPathFind
...
JSS ( send_max );                   // in: PathRequest, SDChainPathFind
...
JSS ( source_account );             // in: PathRequest, SDChainPathFind
JSS ( source_amount );              // in: PathRequest, SDChainPathFind
JSS ( source_currencies );          // in: PathRequest, SDChainPathFind
