...
#ifndef SDCHAIN_PROTOCOL_DIGEST_H_INCLUDED
#define SDCHAIN_PROTOCOL_DIGEST_H_INCLUDED

#include <sdchain/basics/base_uint.h>
#include <sdchain/beast/crypto/ripemd.h>
#include <sdchain/beast/crypto/sha2.h>
...
/*  Message digest functions used in the SDChain Protocol
...
/** Returns the RIPEMD-160 digest of the SHA256 hash of the message.
    ...
    representing a SDChain account, from a message. Typically the
