...
transResults()
{
    ...
    results
    {
        ...
        { tecNO_DST,                 { "tecNO_DST",                "Destination does not exist. Send SDA to create it."                            } },
        { tecNO_DST_INSUF_SDA,       { "tecNO_DST_INSUF_SDA",      "Destination does not exist. Too little SDA sent to create it."                 } },
        ...
        { tecUNFUNDED_ADD,           { "tecUNFUNDED_ADD",          "Insufficient SDA balance for WalletAdd."                                       } },
        { tecUNFUNDED_OFFER,         { "tecUNFUNDED_OFFER",        "Insufficient balance to fund created offer."                                   } },
        { tecUNFUNDED_PAYMENT,       { "tecUNFUNDED_PAYMENT",      "Insufficient SDA balance to send."                                             } },
        ...
        { temBAD_FEE,                { "temBAD_FEE",               "Invalid fee, negative or not SDA."                                             } },
        ...
        { temBAD_SEND_SDA_LIMIT,     { "temBAD_SEND_SDA_LIMIT",    "Malformed: Limit quality is not allowed for SDA to SDA."                       } },
        { temBAD_SEND_SDA_MAX,       { "temBAD_SEND_SDA_MAX",      "Malformed: Send max is not allowed for SDA to SDA."                            } },
        { temBAD_SEND_SDA_NO_DIRECT, { "temBAD_SEND_SDA_NO_DIRECT","Malformed: No SDChain direct is not allowed for SDA to SDA."                    } },
        { temBAD_SEND_SDA_PARTIAL,   { "temBAD_SEND_SDA_PARTIAL",  "Malformed: Partial payment is not allowed for SDA to SDA."                     } },
        { temBAD_SEND_SDA_PATHS,     { "temBAD_SEND_SDA_PATHS",    "Malformed: Paths are not allowed for SDA to SDA."                              } },
        ...
        { temSDCHAIN_EMPTY,           { "temSDCHAIN_EMPTY",          "PathSet with no paths."                                                        } },
        ...
        { terNO_SDCHAIN,              { "terNO_SDCHAIN",             "Path does not permit rippling."                                                } },
