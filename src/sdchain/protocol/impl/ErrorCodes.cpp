...
template <>
struct hash <sdchain::error_code_i>
{
    std::size_t operator() (sdchain::error_code_i value) const
    {
        return value;
    }
};
...
public:
        ...
        : m_unknown (rpcUNKNOWN, "unknown", "An unknown error code.")
    {
        ...
        add (rpcNO_NETWORK,            "noNetwork",         "Not synced to SDChain network.");
        add (rpcNO_PATH,               "noPath",            "Unable to find a sdchain path.");
