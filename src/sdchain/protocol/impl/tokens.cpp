...
static char sdchainAlphabet[] =
    "6pshnaf39wBUDNEGHJKLM4PQRST7VWXYZ2bcdeCgr5jkm8oFqi1tuvAxyz";
    ...
    void const* token, std::size_t size, bool btc)
{
    ...
    return encodeBase58(temp, expanded,
        temp + expanded, btc ? bitcoinAlphabet : sdchainAlphabet);
}
...
static InverseAlphabet sdchainInverse(sdchainAlphabet);
