...
#ifndef SDCHAIN_PROTOCOL_STAMOUNT_H_INCLUDED
#define SDCHAIN_PROTOCOL_STAMOUNT_H_INCLUDED

#include <sdchain/basics/chrono.h>
#include <sdchain/basics/LocalValue.h>
...
private:
    ...
    bool mIsNative;      // A shorthand for isSDA(mIssue).
    bool mIsNegative;
...
public:
    ...
    STAmount (SDAAmount const& amount);
...
public:
    ...
    STAmount& operator= (SDAAmount const& amount)
    {
...
// IOUAmount and SDAAmount define toSTAmount, defining this
...
inline bool isSDA(STAmount const& amount)
{
    return isSDA (amount.issue().currency);
}
