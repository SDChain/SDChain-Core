...
#ifndef SDCHAIN_PROTOCOL_TER_H_INCLUDED
#define SDCHAIN_PROTOCOL_TER_H_INCLUDED
...
// See https://sdchain.io/wiki/Transaction_errors
//
...
enum TER
{
    ...
    temBAD_PATH,
    temBAD_PATH_LOOP,
    temBAD_SEND_SDA_LIMIT,
    temBAD_SEND_SDA_MAX,
    temBAD_SEND_SDA_NO_DIRECT,
    temBAD_SEND_SDA_PARTIAL,
    temBAD_SEND_SDA_PATHS,
    temBAD_SEQUENCE,
    temBAD_SIGNATURE,
    temBAD_SRC_ACCOUNT,
    ...
    terNO_SDCHAIN,        // Rippling not allowed
    ...
    // 100 .. 159 C
    //   Claim fee only (sdchain transaction with no good paths, pay to
