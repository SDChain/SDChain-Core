...
#ifndef SDCHAIN_CORE_STOPPABLE_H_INCLUDED
#define SDCHAIN_CORE_STOPPABLE_H_INCLUDED
...
#include <sdchain/core/ClosureCounter.h>
#include <atomic>
#include <chrono>
...
/** Provides an interface for starting and stopping.
    ...
    The form of the Stoppable tree in the sdchaind application evolves as
